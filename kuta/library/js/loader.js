...
function initDateAxisLineChart() {
  if (document.getElementById('line-chart-date-axis-div')) {
    var cosPoints = eval($('#line-chart-date-axis-div').attr('data-content'));
    var title = $('#line-chart-date-axis-div').attr('data-title');
    var colors = eval($('#line-chart-date-axis-div').attr('data-colors'));

    console.log(cosPoints);

    var plot3 = $.jqplot(
      'line-chart-date-axis-div', cosPoints, 
      { 
	title:title,
	grid: {
	  borderWidth: 0,
